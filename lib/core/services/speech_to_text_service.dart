...
class SpeechToTextService {
  ...
  bool _isPaused = false; // New flag for manual pausing
  ...
  // New method: Pause processing results without stopping the engine
  void pauseListening() {
    _isPaused = true;
    print("SpeechToText: Paused processing results");
  }

  // New method: Resume processing results
  void resumeListening() {
    _isPaused = false;
    print("SpeechToText: Resumed processing results");
  }
